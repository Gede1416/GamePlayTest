...
public class BattleUIManager : MonoBehaviour
{
    ...
    /// <summary>实体就绪：在它头顶的 UI 点位下实例化血条预制体</summary>
    void OnEntitySpawned(EntitySpawnedEvent e)
    {
        if (e.entity == null || e.entity.uiPoint == null || healthBarPrefab == null) return;

        var go = Instantiate(healthBarPrefab, e.entity.uiPoint, false);
        go.GetComponent<HealthBar>().Init(e.entity);
        spawned.Add(go);
    }
